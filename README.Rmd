...
- `data-raw/`: this contains what I term to be the `1.0-beta` release of this random item response model of external territorial threat. I had originally termed it an "index", which would explain the file names.
